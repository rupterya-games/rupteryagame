  ...
  fiordevalle: {
    ...
    exits: [
      { id: "north", name: "Saída Norte", icon: "↑", description: "Bosques frios, capelas quebradas e grutas de alcateia.", levels: [
        { id: "north-lv1", level: 1, name: "Bosque da Cinza", spotCount: 6, recommendedLevel: "Nv. 1–6", signatureCreatureId: "cabra-ladra", creaturePool: ["cabra-ladra", "cellar-rat", "leech-bat", "graveyard-crow"], eventPool: ["Pegadas frescas cortam o barro.", "Uma clareira guarda ervas simples.", "Um acampamento abandonado ainda está quente."] },
        { id: "north-lv2", level: 2, name: "Capela Quebrada", spotCount: 7, recommendedLevel: "Nv. 7–13", signatureCreatureId: "sacristao-oco", creaturePool: ["sacristao-oco", "hanged-vintner", "pale-servant", "ash-wolf"], eventPool: ["Sinos rachados balançam sem vento.", "Velas antigas ardem sobre um altar destruído.", "Marcas de garras e sangue seco cobrem a pedra."] },
        { id: "north-lv3", level: 3, name: "Gruta do Uivo", spotCount: 7, recommendedLevel: "Nv. 14–20", signatureCreatureId: "alfa-uivo-cinzento", bossId: "alfa-uivo-cinzento", creaturePool: ["alfa-uivo-cinzento", "rotted-knight", "crimson-herald", "mist-captain"], eventPool: ["Um uivo sacode a moral do grupo.", "Restos de caçadores revelam um predador dominante.", "A névoa responde aos seus passos."] },
      ] },
      { id: "south", name: "Saída Sul", icon: "↓", description: "Vinhedos, estrada velha e áreas tomadas por saqueadores.", levels: [
        ...
        { id: "south-lv2", level: 2, name: "Casas Desoladas", spotCount: 7, recommendedLevel: "Nv. 7–13", signatureCreatureId: "aranha-de-adega", creaturePool: ["aranha-de-adega", "ash-wolf", "hanged-vintner", "pale-servant"], eventPool: ["Portas batem sozinhas.", "Uma lareira apagada sugere ocupação recente.", "Símbolos de proteção foram riscados às pressas."] },
  ...
  dustfall: {
    ...
    exits: [
      ...
      { id: "east", name: "Saída Leste", icon: "→", description: "Salinas abertas e sentinelas enterradas.", levels: [
        { id: "dust-east-lv1", level: 1, name: "Planície Branca", spotCount: 6, recommendedLevel: "Nv. 36–40", signatureCreatureId: "abutre-de-sal", creaturePool: ["abutre-de-sal", "walking-cinder", "dust-worm"], eventPool: ["O horizonte branco apaga qualquer referência.", "Algo metálico emerge do sal.", "O vento carrega cinza quente sobre a planície."] },
