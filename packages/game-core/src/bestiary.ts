...
export const archetypeProfiles: Record<CreatureArchetype, ArchetypeProfile> = {
  swarm: { hp: 0.55, phys: 0.7, magic: 0.0, pdef: 0.6, mdef: 0.6, crit: 3, dodge: 8 },
  skirmisher: { hp: 0.85, phys: 1.25, magic: 0.0, pdef: 0.8, mdef: 0.8, crit: 12, dodge: 14 },
  brute: { hp: 1.35, phys: 1.15, magic: 0.0, pdef: 1.05, mdef: 0.7, crit: 6, dodge: 3 },
  caster: { hp: 0.75, phys: 0.25, magic: 1.35, pdef: 0.6, mdef: 1.4, crit: 8, dodge: 6 },
  tank: { hp: 1.8, phys: 0.75, magic: 0.0, pdef: 1.5, mdef: 1.2, crit: 3, dodge: 2 },
};
...
export function deriveCreatureStats(
  ...
  return {
    hpMax: round((40 + level * 14) * a.hp * r.hp),
