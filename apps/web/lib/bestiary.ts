...
const seeds: CreatureSeed[] = [
  ...
  // ===== Horda Verde ========================================================
  { id: "goblin-batedor", name: "Goblin Batedor", portraitPath: "/art/creatures/basic/goblin-basic.png", description: "Corre à frente do bando marcando quem está sozinho na estrada.", family: "humanoid", archetype: "swarm", rarity: "common", level: 3, regionId: "fiordevalle-passo-quebrado", weak: { physical: 10 }, ai: ["gritar-alarme se turno == 1", "fugir se aliados_vivos == 0", "ataque-basico sempre"], pack: [3, 5], mats: [["bandagem-suja", 1, 2]], rolls: ["essencia-primaria", "goblin-cleaver"], lore: "Nunca luta até o fim. Ele foi enviado para contar quantos vocês são." },
