...
const DEFAULT_CROP: UnitPortraitCrop = {
  portraitPosition: "50% 7%",
  portraitScale: 1.22,
};

const CROP_MAP: Record<string, UnitPortraitCrop> = {
  samurai: { portraitPosition: "50% 6%", portraitScale: 1.32 },
  kael: { portraitPosition: "50% 6%", portraitScale: 1.32 },
  archer: { portraitPosition: "50% 5%", portraitScale: 1.30 },
  arqueira: { portraitPosition: "50% 5%", portraitScale: 1.30 },
  elyra: { portraitPosition: "50% 5%", portraitScale: 1.30 },
  mage: { portraitPosition: "50% 6%", portraitScale: 1.24 },
  mago: { portraitPosition: "50% 6%", portraitScale: 1.24 },
  paladin: { portraitPosition: "50% 5%", portraitScale: 1.34 },
  paladino: { portraitPosition: "50% 5%", portraitScale: 1.34 },
  aldren: { portraitPosition: "50% 5%", portraitScale: 1.34 },
  guardian: { portraitPosition: "50% 5%", portraitScale: 1.34 },
  guardião: { portraitPosition: "50% 5%", portraitScale: 1.34 },
  orc: { portraitPosition: "50% 5%", portraitScale: 1.34 },
  goblin: { portraitPosition: "50% 5%", portraitScale: 1.32 },
  shaman: { portraitPosition: "50% 4%", portraitScale: 1.34 },
  xama: { portraitPosition: "50% 4%", portraitScale: 1.34 },
  xamã: { portraitPosition: "50% 4%", portraitScale: 1.34 },
